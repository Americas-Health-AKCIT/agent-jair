...
with st.sidebar:
    ...
    if requisitions:
        ...
        if req_options:
            ...
            load_req_pressed = st.button("Carregar Requisição", use_container_width=True)
            change_button_color(
                "Carregar Requisição", 
                font_color="black", 
                background_color="rgb(255,255,255)", 
